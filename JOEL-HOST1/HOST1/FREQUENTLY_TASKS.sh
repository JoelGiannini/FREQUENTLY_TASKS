...
read V_new
line=`cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -nw $V_serv | awk -F':' '{print $1}'|tr -d "\015"`
sudo sed -i "${line} s/${V_serv}/${V_new}/g" /home/ibmunx/JOEL/HOST1/Inventario.txt
V_serv=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt > /dev/null 2>&1
...
read V_new
line=`cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -nw $V_serv | awk -F':' '{print $1}'|tr -d "\015"`
sudo sed -i "${line} s/${V_con}/${V_new}/g" /home/ibmunx/JOEL/HOST1/Inventario.txt
V_con=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt > /dev/null 2>&1
...
read V_new
line=`cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -nw $V_serv | awk -F':' '{print $1}'|tr -d "\015"`
sudo sed -i "${line} s/${V_ip}/${V_new}/g" /home/ibmunx/JOEL/HOST1/Inventario.txt
V_ip=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt > /dev/null 2>&1
...
read V_new
line=`cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -nw $V_serv | awk -F':' '{print $1}'|tr -d "\015"`
sudo sed -i "${line} s/${V_ubi}/${V_new}/g" /home/ibmunx/JOEL/HOST1/Inventario.txt
V_ubi=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt > /dev/null 2>&1
...
read V_new
line=`cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -nw $V_serv| awk -F':' '{print $1}'|tr -d "\015"`
sudo sed -i "${line} s/${V_serial}/${V_new}/g" /home/ibmunx/JOEL/HOST1/Inventario.txt
V_serial=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt > /dev/null 2>&1
...
echo "$line"
read
sudo sed -i "${line} s/${V_tipo}/${V_new}/g"/home/ibmunx/JOEL/HOST1/Inventario.txt
V_tipo=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt > /dev/null 2>&1
