...
V_serv=`cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -wi $V_server | awk '{print $1}'` 
V_con=`cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -wi $V_server | awk '{print $2}'`
V_ip=`cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -wi $V_server | awk '{print $3}'` 
V_ubi=`cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -wi $V_server | awk '{print $4}'`
V_serial=`cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -wi $V_server | awk '{print $5}'`
V_tipo=`cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -wi $V_server | awk '{print $6}'`
V_os="Sist_ope"
V_re="Release"
V_status="Status"
STATUS="Online"
...
if [[ `cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -wi $V_server | awk '{print $1}'` == "" ]]
   			then
	...
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt
	echo "$V_serv  |$V_con  |$V_ip  |$V_ubi  |$V_serial  |$OS  |$V_tipo  |$RELEASE  |$STATUS" | sudo tee --append /home/ibmunx/JOEL/temp.txt
	clear
	echo -e "${V_cyan}################################################################################################################################################${NC}"
...
RELEASE=`$SSH ibmunx@apsatellitep03 "sudo /home/ibmunx/JOEL/test_os.sh $V_server"|awk '{print $2}'|tr -d "\015"`
	...
	if [[  $OS == "Linux" ]];
	then
	RELEASE=`sudo /home/ibmunx/JOEL/HOST1/trunc_release_linux.sh $V_server|tr -d "\015"`
	fi
...
read V_new
sudo sed -i "s/${V_serv}/${V_new}/i" /home/ibmunx/JOEL/HOST1/Inventario.txt
V_serv=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt
	...
	echo -e "${V_cyan}################################################################################################################################################${NC}"
	echo "`sudo cat /home/ibmunx/JOEL/temp.txt`"|column -t -s "|"
	echo -e "${V_cyan}################################################################################################################################################${NC}"	sudo rm -f /home/ibmunx/JOEL/temp.txt
echo ""
...
read V_new
sudo sed -i "s/${V_con}/${V_new}/i" /home/ibmunx/JOEL/HOST1/Inventario.txt
V_con=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt
...
read V_new
sudo sed -i "s/${V_ip}/${V_new}/i" /home/ibmunx/JOEL/HOST1/Inventario.txt
V_ip=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt
...
read V_new
sudo sed -i "s/${V_ubi}/${V_new}/i" /home/ibmunx/JOEL/HOST1/Inventario.txt
V_ubi=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt
...
read V_new
sudo sed -i "s/${V_serial}/${V_new}/i" /home/ibmunx/JOEL/HOST1/Inventario.txt
V_serial=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt
...
echo "Ingrese TIPO de servidor"
	...
	echo ""
read V_new
sudo sed -i "s/${V_tipo}/${V_new}/i" /home/ibmunx/JOEL/HOST1/Inventario.txt
V_tipo=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt
...
if [[ `cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -wi $V_server | awk '{print $1}'` == "" ]]
	...
	echo "$V_server $V_conso $V_ip_dir $V_ubic $V_sn $V_tp" | sudo tee --append /home/ibmunx/JOEL/HOST1/Inventario.txt   
	clear
		V_serv=`cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -wi $V_server | awk '{print $1}'` 
		V_con=`cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -wi $V_server | awk '{print $2}'`
		V_ip=`cat /home/ibmunx/JOEL/HOST1/Inventario.txt  | grep -wi $V_server | awk '{print $3}'` 
...
if [[  $PING_TEST == "ERROR" ]];
	...
	if [[  $aux == "y" ]]
	then
	sudo sed -i "/${V_serv}/d" /home/ibmunx/JOEL/HOST1/Inventario.txt
...
then
	...
	if [[  $SSH_TEST == "ERROR" ]];
		...
		sudo nohup /home/ibmunx/JOEL/HOST1/collect_audit_oracleRE.sh $V_server </dev/null &>/dev/null & 
		clear
		 echo -e "${V_red}PROGRESO DE LA EJECUCION DEL SCRIPT DE AUDITORIA:${NC}:"
		PROCESS=collect_audit_oracleRE.sh
		F_barra_de_carga;
...
RELEASE=`$SSH ibmunx@apsatellitep03 "sudo /home/ibmunx/JOEL/test_os.sh $V_server"|awk '{print $2}' `
	...
	read PROBLEM
		if [[ `cat /home/ibmunx/JOEL/HOST1/Inventario.txt | grep -wi $V_server | awk '{print $4}' | grep -i vel` == "" ]];
		then
...
while [ $aux -lt 1 ] || [ $aux -gt 2 ]
		...
		if [[  $aux == "1" ]]
		then
		echo -e "Se solicita la apertura de un caso de hardware de severidad 1. \nSe detallan los datos del equipo: \n\nProblemática: \n$PROBLEM \n\nDatos del servidor: \nHostname: $V_serv \nSerial number: $V_serial \n\nUbicacion fisica del equipo: \n$V_dir \n$V_ubi \n\nDatos de contacto: \nMail: \nTLF-UNX@kyndryl.com \nTelefono: \n+54-911-5286-1180 \n\nDesde ya muchas gracias, saludos. \n\n\nKYNDRYL UNIX TEAM \nCIC Argentina, Global Technology Services \nPHONE: +54-911-5286-1180 \nE-mail: TLF-UNX@kyndryl.com " |mail -s "From:TLF-UNX@kyndryl.comTLF-UNX@kyndryl.com Generacion de caso de severidad 1" matias.joel.giannini@kyndryl.com
		echo ""
...
while [ $aux -lt 1 ] || [ $aux -gt 2 ]
		...
		if [[  $aux == "1" ]]
		then
		echo -e "Se solicita la apertura de un caso de hardware de severidad 1. \nSe detallan los datos del equipo: \n\nProblemática: \n$PROBLEM \n\nDatos del servidor: \nHostname: $V_serv \nSerial number: $V_serial \n\nUbicacion fisica del equipo: \n$V_dir \n$V_ubi \n\nDatos de contacto: \nMail: \nTLF-UNX@kyndryl.com \nTelefono: \n+54-911-5286-1180 \n\nDesde ya muchas gracias, saludos. \n\n\nKYNDRYL UNIX TEAM \nCIC Argentina, Global Technology Services \nPHONE: +54-911-5286-1180 \nE-mail: TLF-UNX@kyndryl.com " |mail -s "From: TLF-UNX@kyndryl.com Generacion de caso de severidad 1" matias.joel.giannini@kyndryl.com
		echo ""
		echo "Se evio el mail a Roer"
		echo -e "${V_yellow}1${NC}) Volver al menu principal:"
			read aux
...
then
	...
	if [[  $SSH_TEST == "ERROR" ]];
		...
		OS=`$SSH ibmunx@apsatellitep03 "sudo /home/ibmunx/JOEL/test_os.sh $V_server"|awk '{print $1}'|tr -d "\015"`
		RELEASE=`$SSH ibmunx@apsatellitep03 "sudo /home/ibmunx/JOEL/test_os.sh $V_server"|awk '{print $2}'|tr -d "\015"`
		$SSH ibmunx@apsatellitep03 "sudo nohup sh /home/ibmunx/JOEL/HOST1/soxRE.sh $V_server $OS </dev/null &>/dev/null &" 
		...
		sudo nohup sh /home/ibmunx/JOEL/HOST1/soxRE.sh $V_server $OS </dev/null &>/dev/null & 
		clear
		 echo -e "${V_red}PROGRESO DE LA EJECUCION DEL SCRIPT DE SOX:${NC}:"
		PROCESS="soxRE.sh"
		F_barra_de_carga;
...
test_os;
		...
		if [ "$OS" == "Linux" ]
 		then
		$SCP /home/ibmunx/JOEL/HOST1/elasticsearch-7.16.2-x86_64.rpm  ibmunx@$V_server:/home/ibmunx/
