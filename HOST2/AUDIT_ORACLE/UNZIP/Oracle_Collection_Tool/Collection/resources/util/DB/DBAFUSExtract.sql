...
SET PAUSE OFF
SET TERMOUT OFF
REM     ORACLE - Global Licensing and Advisory Services - DBA_FEATURE_USAGE_STATISTICS Extract Script
REM
REM     Prerequisites:
...
BEGIN
  ...
  dbms_output.put_line('DB: CT-02000: COLLECTED: Database Instance: ' || INSTANCE_N || PDB_N || ' running on Host: ' || HOST_N);
END;
/
SPOOL OFF
