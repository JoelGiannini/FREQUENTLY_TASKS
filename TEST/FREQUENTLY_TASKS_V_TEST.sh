...
read V_new
sudo sed -i "s/${V_serv}/${V_new}/i" /home/ibmunx/JOEL/PRUEBA/Inventario.txt
V_serv=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt
...
read V_new
sudo sed -i "s/${V_con}/${V_new}/i" /home/ibmunx/JOEL/PRUEBA/Inventario.txt
V_con=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt
...
read V_new
sudo sed -i "s/${V_ip}/${V_new}/i" /home/ibmunx/JOEL/PRUEBA/Inventario.txt
V_ip=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt
...
read V_new
sudo sed -i "s/${V_ubi}/${V_new}/i" /home/ibmunx/JOEL/PRUEBA/Inventario.txt
V_ubi=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt
...
read V_new
sudo sed -i "s/${V_serial}/${V_new}/i" /home/ibmunx/JOEL/PRUEBA/Inventario.txt
V_serial=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt
...
echo "Ingrese TIPO de servidor"
	...
	echo ""
read V_new
sudo sed -i "s/${V_tipo}/${V_new}/i" /home/ibmunx/JOEL/PRUEBA/Inventario.txt
V_tipo=$V_new
clear
	sudo touch /home/ibmunx/JOEL/temp.txt
	echo "$V_servidor  |$V_consola  |$V_ip_prod  |$V_ubicacion  |$V_serial_id  |$V_os  |$V_TIPO  |$V_re  |$V_status" | sudo tee --append /home/ibmunx/JOEL/temp.txt
